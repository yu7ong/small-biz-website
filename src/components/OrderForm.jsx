...
function OrderForm({ formData, onInputChange, onProceedToPayment }) {
  return (
    <div className="flex flex-col sm:flex-row justify-between gap-4 pt-5 mt-18 sm:pt-14 min-h-[80vh] sm:pr-10">
      {/* Left side */}
        ...
        <div className="w-full">
          ...
          <div className="border border-[#38342c] rounded py-1.5 px-3.5 w-full gaegu">
            <label className="block text-m gaegu mb-4">
              This is a preorder form for EVENTNAME. Which day would you like to
